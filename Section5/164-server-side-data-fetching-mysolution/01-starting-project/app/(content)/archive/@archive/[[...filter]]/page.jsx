...
import FilteredNewsPage from '@/components/filtered-news-page'
import React, { Suspense } from 'react'

async function FilteredNewsPage2({ params }) {
	...
	return (
		...
		<FilteredNewsPage params={params} />
		</Suspense>
...
export default FilteredNewsPage2
